...
class Contacts {
    ...
    timezoneBtn = "/html/body/div[3]/div/div[2]/form/div/div[3]/div"
    searchTimezoneField = "/html/body/div[4]/div/div/div[1]/input"
    phoneNumberField = "/html/body/div[3]/div/div[2]/form/div/div[4]/div/div/input"
    ...
    searchTimezone(name){
        cy.xpath(this.searchTimezoneField).type(name);
    }
